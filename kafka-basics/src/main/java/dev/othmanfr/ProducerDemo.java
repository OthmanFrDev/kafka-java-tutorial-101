...
public class ProducerDemo {
    ...
    public static void main(String[] args) {
        ...
        // send data
        asyncProduce(producer,producerRecord);
    ...
    private static void asyncProduce(KafkaProducer producer,ProducerRecord producerRecord){
        try {
    ...
    private static void syncProduce(KafkaProducer producer,ProducerRecord producerRecord){
        producer.send(producerRecord, new Callback() {
            ...
            public void onCompletion(RecordMetadata metadata, Exception exception) {
                if(exception!=null){
                    ...
                    log.info("Event sended successfully to topic {}",metadata.topic());
                }
            }
        });
    }
